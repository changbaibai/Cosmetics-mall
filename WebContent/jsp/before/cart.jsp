...
<script type="text/javascript">
	...
	function  goOrderConfirm(){
		window.location.href="/cosmetics/cart/orderConfirm";
	}
	//清空
	function godelete(){
		if(window.confirm("真的清空购物车吗？")){
			window.location.href="/cosmetics/cart/clear";
			return true;
		}
		return false;
	}
	...
	function deleteAgoods(gno){
		if(window.confirm("真的删除该商品吗？")){
			window.location.href="/cosmetics/cart/deleteAgoods?id=" + gno;
			return true;
		}
		return false;
	}
				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<tr>
						<td bgcolor="#ffffff" colspan="4" align="right"
							...
							<a href="before"> <img src="images/before/car01.png" alt="" />
						</a>
						</td>
						<td bgcolor="#ffffff" align="center"
							style="border-left: 0 none; padding: 1px; padding-right: 1px;">
							<a style="cursor: pointer;" href="javascript:goOrderConfirm()">
								<img src="images/before/car02.png" alt="" />
						</a>
						</td>
					</tr>
				</table>
